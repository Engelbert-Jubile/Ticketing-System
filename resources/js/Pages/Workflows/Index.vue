  ...
  <div class="mx-auto max-w-7xl space-y-6">
    ...
    <section class="card !p-0">
      <div class="grid gap-3 border-b border-slate-200 p-4 md:grid-cols-[1fr_170px_190px_auto] dark:border-slate-700">
        <label class="relative"><span class="material-icons pointer-events-none absolute left-3 top-2.5 text-lg text-slate-400">search</span><input v-model="search" type="search" placeholder="Cari nomor, judul, requester, atau PIC..." class="input pl-10" @keyup.enter="applyFilters" /></label>
